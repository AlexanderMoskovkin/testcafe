...
describe('API', function () {
    ...
    describe('fixture', function () {
        ...
        it.only('Should collect meta data', function () {
        ...
        it.only('Should raise an error if fixture.meta is undefined', function () {
...
describe('test', function () {
    ...
    it.only('Should raise an error if test.meta is undefined', function () {
        ...
        return compile(file)
            ...
            .catch(function (err) {
                assertAPIError(err, {
                    ...
                    message: 'Cannot prepare tests due to an error.\n\n' +
                             'test.meta is expected to be a string or a non-null object, but it was undefined.',
